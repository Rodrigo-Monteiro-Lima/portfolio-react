      ...
      <figure>
        ...
        <blockquote className="mb-6">
          <p className="text-2xl text-gray-900">
            ...
            voluptatum, quos, quibusdam, voluptates voluptate quia quod
            voluptatibus quae doloribus fugit. Quisquam a voluptatum, quos,
            quibusdam, voluptates voluptate quia quod voluptatibus quae
          </p>
        </blockquote>
        <figcaption className="flex items-center justify-center gap-2">
          ...
          <div className="flex items-center divide-x-2 divide-gray-200">
            <div className="pr-3 font-medium text-gray-900">Fulano</div>
